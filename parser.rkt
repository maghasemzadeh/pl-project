  ...
  (lambda (compund-statement env)
    (cases compound-stmt compund-statement
      ...
      (compound-stmt-if-stmt (stmt)
                             (value-of-compound-stmt-if-stmt stmt env)
                             )
      (compound-stmt-for-stmt (stmt)
                              (value-of-compound-stmt-for-stmt stmt env)
                              )
...
(define value-of-compound-stmt-if-stmt
  'f
  )

(define value-of-compound-stmt-for-stmt
  'f
  )
